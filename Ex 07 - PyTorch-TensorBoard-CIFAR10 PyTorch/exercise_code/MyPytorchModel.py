...
class MyPytorchModel(nn.Module):
    ...
    def __init__(self, hparams):
        ...
        nn.ReLU(),  
        nn.Dropout(p=0.2),
        nn.Linear(200, hparams['num_classes'])
        )
...
class CIFAR10DataModule(nn.Module):
    ...
    def prepare_data(self, stage=None, CIFAR_ROOT="../exercise_07/datasets/cifar10"):
        mean = [0.485, 0.456, 0.406]
        std = [0.229, 0.224, 0.225]

        # create dataset
        # CIFAR_ROOT = "../datasets/cifar10"
        CIFAR_ROOT="../exercise_07/datasets/cifar10"
        my_transform = None
        mean = [0.485, 0.456, 0.406]
        std = [0.229, 0.224, 0.225]
        ########################################################################
        ...
        my_transform = transforms.Compose([
          transforms.RandomApply((transforms.RandomHorizontalFlip(p=0.8), transforms.RandomResizedCrop((32,32))), p=0.1),
          transforms.ToTensor(),
